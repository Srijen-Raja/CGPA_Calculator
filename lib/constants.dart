...
List<Constants> themes = [
  ...
  Constants(
    theme: "Coffee",
    backcolor: Color(0xF7563D27),
    butcolor: Color(0xFF85674A),
    bordcolor: Color(0xFFD2B478),
    cardcolor: Color(0xFF5B4129),
    textcolor: Color(0xFFEAC578),
    sepcolor: Color(0xFFC4A875),
    highcolor: Color(0xFFF8D8A8),
    unscolor: Color(0xFF84673F),
    iconcolor: Color(0xFFEAC77E),
  ),
  Constants(
    theme: "Emerald",
